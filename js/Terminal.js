export default class Terminal {
    ...
    $$ |        $$ |  $$ |        $$ |  $$ |            $$\\   $$ | $$  /    $$ |      $$ |  $$ |$$ |  $$ |$$ |  $$ |$$$  / \\$$$ |$$\\   $$ |$$ |\\$$\\    $$ |  
    $$ |      $$$$$$\\ $$$$$$$$\\ $$$$$$\\ $$ |            \\$$$$$$  |$$$$$$$$\\ $$$$$$$$\\ $$ |  \\__| \\$$$$$$  | $$$$$$  |$$  /   \\$$ |\\$$$$$$  |$$ | \\$$\\ $$$$$$\\ 
    \\__|      \\______|\\________|\\______|\\__|             \\______/ \\________|\\________|\\__|       \\______/   \\______/ \\__/     \\__| \\______/ \\__|  \\__|\\______|
            `;
        }

        this.output.innerHTML += `
            <pre style="color: #28c940; font-size: 10px; line-height: 10px;">${asciiContent}</pre><br>`;
    }
}